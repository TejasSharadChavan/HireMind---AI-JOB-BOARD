        ...
        messages: [
          {
            ...
            content: [
              ...
              {
                type: "text",
                text: "Summarize the following resume and extract all key skills, experience, and qualifications. The summary should include all the information that a hiring manager would need to know about the candidate in order to determine if they are a good fit for a job. This summary should be formatted as markdown. Do not return an other text. Iffile does not look like a resume return the text 'N/A'.",
              },
            ],
          },
        ],
