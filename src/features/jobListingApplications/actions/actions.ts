...
import { ApplicationStage, applicationStages, JobListingTable, UserResumeTable } from "@/drizzle/schema";
...
export async function createJobListingApplication(
  ...
  unsafeData: z.infer<typeof newJobListingApplicationSchema>
    ...
    if(!success){
        return{
            error:true,
            message:"There is an error submitting your application"
        }
    }
    ...
    return {
        error:false,
        message:"Your application has successfully submitted"
    }
}
